...
static func calculate_bounds(pos: Vector3, brush_size: float, terrain: MstTerrain) -> BrushBounds:
...
static func cell_to_world_pos(chunk_coords: Vector2i, cell_coords: Vector2i, terrain: MstTerrain) -> Vector2:
...
static func get_cell_range_for_chunk(chunk_coords: Vector2i, bounds: BrushBounds, terrain: MstTerrain) -> Dictionary:
